...
vault follows that identity.

## 6. Run the e2e harness

```bash
./run_e2e.sh
```

Intended result: applies the readiness tiers documented in
`TEST_INFRA.md` / `TEST_READY.md` and prints a pass/fail per route + flow.
